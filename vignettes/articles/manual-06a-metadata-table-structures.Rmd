...
You prepare the metadata tables yourself, so this page documents **every column and what it is
for**. Each importer accepts the same three input modes — a **CSV file** (`path =`), a **sheet in
...
Identifier columns must line up across tables: `analysis_id` / `sample_id` match the analysis
