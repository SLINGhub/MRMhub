...
**Caution.** Drift and batch corrections must be fitted on dedicated *reference* samples (typically QC pools), never on study samples [@broadhurst2018GuidelinesConsiderationsUse]. The `correct_drift_gaussiankernel()` option that fits on study samples is the sole exception and is only safe for large, well-randomised cohorts.
:::
