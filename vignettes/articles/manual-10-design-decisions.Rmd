...
To process data directly, see the [Design Overview](manual-00-design-overview.html) instead.
...
- [Design Overview](manual-00-design-overview.html) — the pipeline at a high level
