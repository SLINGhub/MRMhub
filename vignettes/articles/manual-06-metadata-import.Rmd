...
post processing of data. MRMhub therefore inspects imported data/metadata
for completeness of data and consistency of IDs used across differet
metadata tables. After importing metadata a summary of identified error,
warnings and notes concerning metadata is printed to the console, to
...
an Excel file (`.xlsx`). This template offers tables for all
