...
Load the package in your R session via `library(mrmhub)`. For detailed usage instructions and examples, refer to the [Documentation](https://slinghub.github.io/MRMhub/quant/).
...
- [Installation](manual-00-get-started.html) — requirements and setup
- [Key Concepts & Glossary](manual-00-key-concepts.html) — core terminology and the MRMhubExperiment object
