...
| MRMhub             | [`import_data_mrmhub()`](https://slinghub.github.io/MRMhub/reference/import_data_mrmhub.md)     | Long format output format                                                                                                                                             | .csv or .tsv |
| Skyline            | [`import_data_skyline()`](https://slinghub.github.io/MRMhub/reference/import_data_skyline.md)   | Skyline Small Molecule Transition Results (long format)                                                                                                               |              |
| Generic wide CSV   | [`import_data_csv_wide()`](https://slinghub.github.io/MRMhub/reference/import_data_csv_wide.md) | Samples/analyses as rows and features as columns. Can contain columns specific sample annotations.                                                                    | .csv         |
| Generic long CSV   | [`import_data_csv_long()`](https://slinghub.github.io/MRMhub/reference/import_data_csv_long.md) | Long-format table with each row being a unique `analysis_id` and `feature_id` pair and addtional columns representing feature variables and sample/method information | .csv         |
