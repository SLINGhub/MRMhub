...
data/metadata for completness of data and consistency of IDs used across
differet metadata tables. After importing metadata a summary of
identified error, warnings and notes cocerning metadata is printed to
...
metadata types supported by MRMhub, with options to do perform checks on
