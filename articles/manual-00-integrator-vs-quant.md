...
scientists who do not write R, the recommended path is to team up with a
bioinformatician or core-facility analyst: the package is designed so
that processing scripts can be authored once and re-run unchanged across
cohorts, with QC outputs that are readable without needing R knowledge.
The 5-minute [Your First
...
- [INTEGRATOR Manual
  ↗](https://slinghub.github.io/MRMhub/integrator-manual.html) (separate
  site)
