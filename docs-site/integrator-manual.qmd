...
description: |
  Reference manual for INTEGRATOR — the stand-alone peak-integration application of the MRMhub
  pipeline. Covers installation, input file formats (param.txt, batch_info.csv,
  transition_list.csv), the four processing steps, and the MRMhub-viz Visualizer.
editor_options:
  markdown:
    wrap: 72
---
...
Instructions](msconvert.qmd) for details.
