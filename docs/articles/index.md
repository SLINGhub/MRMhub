...
- [Your First
  ...
  A 5-minute walkthrough: import demo data, inspect, normalize, and
  export.
...
- [Validating and Fixing
  ...
  How to validate analysis, feature, and ISTD annotations before
  processing, diagnose common defects, and generate a metadata template
  from your data.
