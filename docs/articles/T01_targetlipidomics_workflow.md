...
plot_rt_vs_chain(
  ...
  base_font_size = 8, 
  point_size = 1)  
#> ℹ The following features were flagged as potential annotation outliers: DG 18:1_20:0 [-18:1], DG 14:1_20:0 [-20:0], PC 32:1, PC 32:2, SM 40:1, SM 39:1, SM 36:2, SM 36:2 d9 (ISTD), SM 38:3|PC 33:1 d7 M+2, TG O-51:2 [-18:1]
```
...
mrmhub::save_report_xlsx(myexp, path = "./output/myexp-mrmhub_report.xlsx")
#> Saving report to disk - please wait...
#> ✔ The data processing report of experiment 'sPerfect' has been saved to './output/myexp-mrmhub_report.xlsx'.
```
...
mrmhub::save_dataset_csv(
  ...
  include_qualifier = FALSE,
  filter_data = TRUE)
#> ✔ Concentration values for 377 analyses and 324 features have been exported to './output/sperfect_filt_uM.csv'.
```
...
saveRDS(myexp, file = "./output/myexp-mrmhub.rds", compress = TRUE)
my_saved_exp <- readRDS(file = "./output/myexp-mrmhub.rds")
print(myexp)
#> 
#> ── MRMhubExperiment ────────────────────────────────────────────────────────────
#> Title: sPerfect
