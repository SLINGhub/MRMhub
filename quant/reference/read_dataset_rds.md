...
#> ✔ MRMhubExperiment saved to /tmp/Rtmp9H1zbo/example_mexp.rds.
#> Content fingerprint: "4c3091c633ef436188dce7ac3a1825fd"
mexp2 <- read_dataset_rds(path)
#> ✔ Content fingerprint verified: "4c3091c633ef436188dce7ac3a1825fd".
#> ✔ Loaded MRMhubExperiment from /tmp/Rtmp9H1zbo/example_mexp.rds.
```
