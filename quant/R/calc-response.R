...
#' for each response curve in the provided `MRMhubExperiment` object. Optionally, it can include
#' additional statistics from the `lancer` package (if installed) when `with_staturation_stats` is set to TRUE.
#'
#' @param data A `MRMhubExperiment` object containing the dataset and response curve annotations.
