...
# mexp <- mrmhub::import_data_masshunter(mexp, path = testthat::test_path("4_Testdata_MHQuant_DefaultSampleInfo_RT-Areas-FWHM_DetailedMethods.csv"), import_metadata = FALSE)
# mexp <- mrmhub::import_metadata_msorganiser(mexp,
#                                         path = testthat::test_path("testdata/MRMhub_Metadata_Template_191_20240226_MHQuant_S1P_V1.xlsm"),
...
test_that("set_analysis_order orders according to set criteria and absence/presence of timestamp", {
  ...
  mexp <- mrmhub::import_metadata_msorganiser(
    mexp,
    path = testthat::test_path(
      "MRMhub_Metadata_Template_191_20240226_MHQuant_S1P_V1_reorder.xlsm"
    ),
    excl_unmatched_analyses = FALSE
  )
