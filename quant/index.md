...
The same command installs later updates. [Alternative
methods](https://slinghub.github.io/MRMhub/quant/articles/manual-00-installation.html#alternative-installation-methods)
using `pak` or `remotes` are described in the guide.
