...
```
# Prerequisites
MRMhub requires R version 4.2.0 or higher, available from [CRAN](https://cran.r-project.org).
...
While `MRMhub`'s core functionality requires no R coding skills,
...
[Preparing and importing data](T01_prepdata.html) and [A basic MRMhub workflow](T02_settingup_workflow.html) offer essential information 
to get you started smoothly.

Some MRMhub functions, particularly those for plotting, have many arguments
...
details on data structures and the use of MRMhub functions, and the
