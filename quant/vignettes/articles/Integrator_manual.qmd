...
| ameter |                    |           |
+========+====================+===========+
| mzML   | Location of mzML   | mzML      |
| _files | files to be used   |           |
|        | for peak           |           |
|        | integration        |           |
+--------+--------------------+-----------+
| batc   | Input file with    | batch     |
| h_info | mzML file names    | _info.csv |
|        | and meta           |           |
|        | information (see   |           |
|        | below)             |           |
+--------+--------------------+-----------+
| tra    | Input file with    | feature   |
| nsitio | MRM transition     | \         |
| n_list | information (see   | _info.csv |
|        | below)             |           |
+--------+--------------------+-----------+
| peak   | \[w, x, y, z\]     | \[0.17,   |
| _width | define allowed     | 0.05,     |
|        | integration        | 0.1,      |
|        | bounds:\           | 0.35\]    |
|        | left = w–x min,    |           |
|        | right = y–z min    |           |
...
|        | below).            |           |
+--------+--------------------+-----------+
| num\_  | Number of CPU      | 2         |
| t      | threads to be used |           |
| hreads | for integration    |           |
|        | task.              |           |
+--------+--------------------+-----------+
...
|        | samples            |           |
+--------+--------------------+-----------+
| RT     | Maximum allowed RT | 0.1       |
| _shift | drift between      |           |
| _bound | adjacent samples   |           |
+--------+--------------------+-----------+
