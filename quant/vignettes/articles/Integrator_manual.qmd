...
+================+==============+===========+
| mzML \_files   | Location of  | mzML      |
|                | mzML files   |           |
|                | to be used   |           |
|                | for peak     |           |
|                | integration  |           |
+----------------+--------------+-----------+
| batc h_info    | Input file   | batch     |
|                | with mzML    | \         |
|                | file names   | _info.csv |
|                | and meta     |           |
|                | information  |           |
|                | (see below)  |           |
+----------------+--------------+-----------+
| tra nsitio     | Input file   | feature\  |
| n_list         | with MRM     | \         |
|                | transition   | _info.csv |
|                | information  |           |
|                | (see below)  |           |
+----------------+--------------+-----------+
| peak \_width   | \[w, x, y,   | \[0.17,   |
|                | z\] define   | 0.05,     |
|                | allowed      | 0.1,      |
|                | integration  | 0.35\]    |
|                | bounds:\     |           |
