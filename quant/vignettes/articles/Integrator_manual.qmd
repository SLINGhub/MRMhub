...
+--------+--------------------+--------+
| Pa     | D e s c ription    | D      |
| r      |                    | efault |
| ameter |                    |        |
+========+====================+========+
| m zM   | L ocation of mzML  | mzML   |
| L      | files to be used   |        |
| _files | for peak i n t e   |        |
|        | gration            |        |
+--------+--------------------+--------+
| b at   | Input file with    | ba t c |
| c      | mzML file names    | h \_ i |
| h_info | and meta i n f o   | n      |
|        | rmation (see       | fo.csv |
|        | below)             |        |
+--------+--------------------+--------+
| tra n  | Input file with    | feat u |
| s i ti | MRM t r a nsition  | r e \_ |
| o      | i n f o rmation    | i      |
| n_list | (see below)        | n      |
|        |                    | fo.csv |
+--------+--------------------+--------+
| p ea   | \[w, x, y, z\]     | \      |
| k      | define allowed i n | [0.17, |
| _width | t e gration b      | 0.05,  |
|        | ounds:\            | 0.1,   |
|        | left = w–x min,    | 0.35\] |
|        | right = y–z min    |        |
|        | from apex (see     |        |
...
+--------+--------------------+--------+
| n u    | Number of CPU      | 2      |
| m\_    | threads to be used |        |
| t      | for i n t e        |        |
| hreads | gration task.      |        |
+--------+--------------------+--------+
| mz_tol | T o lerance        | 0.06   |
|        | between i n        |        |
|        | dicated m/z and d  |        |
|        | etected m/z values |        |
+--------+--------------------+--------+
| RT_tol | T o lerance        | 0.1    |
|        | between i n        |        |
|        | dicated RT and d   |        |
|        | etected RT. No     |        |
|        | te\*\*: This is a  |        |
...
+--------+--------------------+--------+
| R      | \[x, y\] i ndicate | \      |
| T      | that RT drift is   | [-0.2, |
| _shift | at most x minutes  | 0.2\]  |
|        | left and y minutes |        |
|        | right of the peak  |        |
|        | in the r e ference |        |
|        | samples            |        |
