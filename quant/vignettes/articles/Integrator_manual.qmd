...
|           | below)    |           |
+-----------+-----------+-----------+
| tra n s i | Input     | feat u r  |
| ti        | file with | e \_      |
| on_list   | MRM t     | info.csv  |
|           | ransition |           |
|           | i n       |           |
|           | formation |           |
|           | (see      |           |
...
|               | the result.          |
+---------------+----------------------+
| sample_type   | The sample (QC) type |
...
|               | Name.              |
+---------------+--------------------+
| **Precursor   | The m/z value of   |
| Ion**         | the precursor ion. |
|               | Must match the     |
|               | corresponding      |
|               | value in the mzML  |
|               | file within the    |
