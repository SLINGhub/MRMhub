...
+---------+-------------------+----------+
| Pa      | D e scription     | Default  |
| rameter |                   |          |
+=========+===================+==========+
| m       | Location of mzML  | mzML     |
| zM      | files to be used  |          |
| L_files | for peak i n      |          |
|         | tegration         |          |
+---------+-------------------+----------+
| b       | Input file with   | ba t c h |
| at      | mzML file names   | \_       |
| ch_info | and meta i n      | info.csv |
|         | formation (see    |          |
|         | below)            |          |
+---------+-------------------+----------+
| tra n s | Input file with   | feat u r |
| i       | MRM t ransition i | e        |
| ti      | n formation (see  | \_       |
| on_list | below)            | info.csv |
+---------+-------------------+----------+
| p       | \[w, x, y, z\]    | \[0.17,  |
| ea      | define allowed i  | 0.05,    |
| k_width | n tegration       | 0.1,     |
|         | bounds:\          | 0.35\]   |
|         | left = w–x min,   |          |
|         | right = y–z min   |          |
|         | from apex (see    |          |
