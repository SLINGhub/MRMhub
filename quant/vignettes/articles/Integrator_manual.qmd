...
| rameter   | scription   |           |
+===========+=============+===========+
| m zM      | Location of | mzML      |
| L_files   | mzML files  |           |
|           | to be used  |           |
|           | for peak i  |           |
|           | n tegration |           |
+-----------+-------------+-----------+
| b at      | Input file  | ba t c h  |
| ch_info   | with mzML   | \_        |
|           | file names  | info.csv  |
|           | and meta i  |           |
|           | n formation |           |
|           | (see below) |           |
+-----------+-------------+-----------+
| tra n s i | Input file  | feat u r  |
| ti        | with MRM t  | e \_      |
| on_list   | ransition i | info.csv  |
|           | n formation |           |
|           | (see below) |           |
+-----------+-------------+-----------+
| p ea      | \[w, x, y,  | \[0.17,   |
| k_width   | z\] define  | 0.05,     |
|           | allowed i n | 0.1,      |
|           | tegration   | 0.35\]    |
|           | bounds:\    |           |
|           | left = w–x  |           |
...
| integration   | peak border for all  |
| bound         | samples, in minutes  |
|               | (with respect to the |
|               | reference sample)    |
+---------------+----------------------+
